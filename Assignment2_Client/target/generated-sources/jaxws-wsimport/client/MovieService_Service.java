 ...
 * 
 */
@WebServiceClient(name = "MovieService", targetNamespace = "http://services/", wsdlLocation = "http://localhost:8080/Assignment2_SOAP_API/MovieService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MOVIESERVICE_QNAME = new QName("http://services/", "MovieService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Assignment2_SOAP_API/MovieService?wsdl");
    ...
    public MovieService getMovieServicePort() {
        return super.getPort(new QName("http://services/", "MovieServicePort"), MovieService.class);
    }
    ...
    public MovieService getMovieServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services/", "MovieServicePort"), MovieService.class, features);
    }
